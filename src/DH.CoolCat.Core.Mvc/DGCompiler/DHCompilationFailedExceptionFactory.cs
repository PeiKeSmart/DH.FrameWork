...
public static class DHCompilationFailedExceptionFactory
{
    ...
    public static DHCompilationFailedException Create(
        ...
        IEnumerable<RazorDiagnostic> diagnostics)
    {
        ...
        return new DHCompilationFailedException(failures);
    }
        ...
        IEnumerable<Diagnostic> diagnostics)
    {
        ...
        foreach (var group in diagnosticGroups)
        {
                ...
                string.Equals(CS0246, g.Id, StringComparison.OrdinalIgnoreCase)))
            {
                ...
                //Resources.FormatCompilation_MissingReferences("CopyRefAssembliesToPublishDirectory");
            }
