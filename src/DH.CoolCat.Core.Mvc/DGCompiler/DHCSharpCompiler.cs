...
public class DHCSharpCompiler
#pragma warning restore CA1852 // Seal internal types
{
    private readonly DHRazorReferenceManager _referenceManager;
    ...
    public DHCSharpCompiler(DHRazorReferenceManager manager, IWebHostEnvironment hostingEnvironment)
    {
