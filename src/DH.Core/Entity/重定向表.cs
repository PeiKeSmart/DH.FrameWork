...
[BindTable("DG_RouteRewrite", Description = "重定向表", ConnName = "DG", DbType = DatabaseType.None)]
public partial class RouteRewrite : IRouteRewrite, IEntity<IRouteRewrite>
{
    #region 属性
    private Int32 _Id;
    /// <summary>编号</summary>
    ...
    public override Object this[String name]
    {
        get => name switch
        {
            ...
            "ReplacementInfo" => _ReplacementInfo,
            "ParentId" => _ParentId,
    ...
    public static IList<RouteRewrite> Search(String regexInfo, DateTime start, DateTime end, String key, PageParameter page)
    {
