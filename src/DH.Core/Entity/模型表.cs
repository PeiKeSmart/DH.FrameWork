...
[BindTable("ModelTable", Description = "模型表。实体表模型", ConnName = "DG", DbType = DatabaseType.None)]
public partial class ModelTable : IModelTable, IEntity<IModelTable>
{
    #region 属性
    private Int32 _Id;
    /// <summary>编号</summary>
    ...
    public void Copy(IModelTable model)
    {
        Id = model.Id;
