...
namespace DH.Entity
{
    ...
    [BindIndex("IX_UserConnect_LinkID", false, "LinkID")]
    ...
    public partial class UserConnect
    {
        ...
        [DisplayName("访问令牌")]
        [Description("访问令牌")]
        [DataObjectField(false, false, true, 1200)]
        ...
        [DisplayName("访问令牌过期时间")]
        [Description("访问令牌过期时间")]
        [DataObjectField(false, false, true, 0)]
        [BindColumn("Expire", "访问令牌过期时间", "")]
        public DateTime Expire { get => _Expire; set { if (OnPropertyChanging("Expire", value)) { _Expire = value; OnPropertyChanged("Expire"); } } }

        private DateTime _RefreshExpire;
        /// <summary>刷新令牌过期时间</summary>
        [DisplayName("刷新令牌过期时间")]
        [Description("刷新令牌过期时间")]
        [DataObjectField(false, false, true, 0)]
        [BindColumn("RefreshExpire", "刷新令牌过期时间", "")]
        public DateTime RefreshExpire { get => _RefreshExpire; set { if (OnPropertyChanging("RefreshExpire", value)) { _RefreshExpire = value; OnPropertyChanged("RefreshExpire"); } } }
        ...
        public override Object this[String name]
        {
            get
            {
                switch (name)
                {
                    ...
                    case "RefreshExpire": return _RefreshExpire;
            ...
            set
            {
                switch (name)
                {
                    ...
                    case "RefreshExpire": _RefreshExpire = value.ToDateTime(); break;
        ...
        public partial class _
        {
            ...
            /// <summary>刷新令牌过期时间</summary>
            public static readonly Field RefreshExpire = FindByName("RefreshExpire");
        ...
        public partial class __
        {
            ...
            /// <summary>刷新令牌过期时间</summary>
            public const String RefreshExpire = "RefreshExpire";
