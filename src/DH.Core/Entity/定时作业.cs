...
[BindTable("CronJob", Description = "定时作业。定时执行任务", ConnName = "DG", DbType = DatabaseType.None)]
public partial class CronJob : ICronJob, IEntity<ICronJob>
{
    #region 属性
    private Int32 _Id;
    /// <summary>编号</summary>
    ...
    public void Copy(ICronJob model)
    {
        Id = model.Id;
        Name = model.Name;
