        ...
        public override Object this[String name]
        {
            get
            {
                switch (name)
                {
                    ...
                    case "SId": return _SId;
                    case "TenantId": return _TenantId;
                    case "UType": return _UType;
                    case "RoleExIds": return _RoleExIds;
                    case "OtherPermissions": return _OtherPermissions;
                    case "DepartmentIds": return _DepartmentIds;
                    case "TrueName": return _TrueName;
                    case "PayPwd": return _PayPwd;
                    case "AuthState": return _AuthState;
                    case "IdCard": return _IdCard;
                    case "IdcardImage1": return _IdcardImage1;
                    case "IdcardImage2": return _IdcardImage2;
                    case "IdcardImage3": return _IdcardImage3;
                    case "CompanyName": return _CompanyName;
                    case "CompnayAuthState": return _CompnayAuthState;
                    case "CorporateName": return _CorporateName;
                    case "BusinessLicenseImage": return _BusinessLicenseImage;
                    case "CorporateImage": return _CorporateImage;
                    case "EmailBind": return _EmailBind;
                    case "MobileBind": return _MobileBind;
                    case "IsSubScribe": return _IsSubScribe;
                    case "IsSales": return _IsSales;
                    case "IsEngineer": return _IsEngineer;
                    case "ReferrerId": return _ReferrerId;
                    case "KeFuId": return _KeFuId;
                    case "ParentUId": return _ParentUId;
                    case "Points": return _Points;
                    case "ExpPoints": return _ExpPoints;
                    case "QQ": return _QQ;
                    ...
                    case "IsBuy": return _IsBuy;
                    case "IsAllowTalk": return _IsAllowTalk;
                    case "AvailablePredeposit": return _AvailablePredeposit;
                    case "FreezePredeposit": return _FreezePredeposit;
                    case "AvailableRcBalance": return _AvailableRcBalance;
                    case "FreezeRcBalance": return _FreezeRcBalance;
                    case "CountryId": return _CountryId;
                    case "AreaId": return _AreaId;
                    case "CityId": return _CityId;
                    case "ProvinceId": return _ProvinceId;
                    case "AreaInfo": return _AreaInfo;
                    case "Question1": return _Question1;
                    case "Answer1": return _Answer1;
                    case "Question2": return _Question2;
                    case "Answer2": return _Answer2;
                    case "Question3": return _Question3;
                    case "Answer3": return _Answer3;
