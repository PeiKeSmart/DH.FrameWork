    ...
    public partial class SystemRout
    {
        ...
        public override Object this[String name]
        {
            get
            {
                ...
                {
                    case "Id": return _Id;
                    case "RType": return _RType;
                    case "Name": return _Name;
                    case "Url": return _Url;
                    case "Parms": return _Parms;
                    case "Pages": return _Pages;
                    case "AreaName": return _AreaName;
                    case "ControllerName": return _ControllerName;
                    case "ActionName": return _ActionName;
