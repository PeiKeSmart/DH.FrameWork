...
public partial class UrlRecord : IUrlRecord, IEntity<IUrlRecord>
{
    ...
    public static IList<UrlRecord> Search(Int32 entityId, String slug, Int32 languageId, Boolean? isActive, DateTime start, DateTime end, String key, PageParameter page)
    {
