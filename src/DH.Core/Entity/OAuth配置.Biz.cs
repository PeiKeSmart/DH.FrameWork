...
public partial class OAuthConfig : DHEntityBase<OAuthConfig> {
    ...
    public override void Valid(Boolean isNew)
    {
        ...
        if (Name.EqualIgnoreCase("ChuangChu"))
        {
    ...
    protected override void InitData()
    {
        ...
        Add("QQ", "QQ", "/images/logo/QQ.png");
        Add("Github", "Github", "/images/logo/Github.png");
        ...
        Add("Weibo", "微博", "/images/logo/Weibo.png");
        Add("Taobao", "淘宝", "/images/logo/Taobao.png");
        Add("Alipay", "支付宝", "/images/logo/Alipay.png");
        Add("Microsoft", "微软", "/images/logo/microsoft-account.svg");
