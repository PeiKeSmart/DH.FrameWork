...
[BindTable("OAuthApp", Description = "应用系统。用于OAuthServer的子系统", ConnName = "DG", DbType = DatabaseType.None)]
public partial class App : IApp, IEntity<IApp>
{
    #region 属性
    private Int32 _Id;
    /// <summary>编号</summary>
    ...
    public static IList<App> Search(Boolean? enable, Boolean? isDeleted, DateTime start, DateTime end, String key, PageParameter page)
    {
