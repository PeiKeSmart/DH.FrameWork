...
[BindTable("ModelColumn", Description = "模型列。实体表的数据列", ConnName = "DG", DbType = DatabaseType.None)]
public partial class ModelColumn : IModelColumn, IEntity<IModelColumn>
{
    #region 属性
    private Int32 _Id;
    /// <summary>编号</summary>
    ...
    public void Copy(IModelColumn model)
    {
        Id = model.Id;
