...
public partial class AppVersionLog : DHEntityBase<AppVersionLog>
{
    #region 对象操作
    static AppVersionLog()
    {
    ...
    //    if (XTrace.Debug) XTrace.WriteLine("开始初始化AppVersionLog[APP版本请求日志]数据……");

    //    var entity = new AppVersionLog();
    //    entity.Id = 0;
    //    entity.Version = "abc";
    ...
    //    if (XTrace.Debug) XTrace.WriteLine("完成初始化AppVersionLog[APP版本请求日志]数据！");
    //}
    ...
    public static IList<AppVersionLog> FindAllByVersion(String version)
    {
        if (version.IsNullOrEmpty()) return new List<AppVersionLog>();
