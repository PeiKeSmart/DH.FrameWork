...
[Serializable]
[DataObject]
[Description("应用插件。基于框架实现的应用功能插件")]
[BindIndex("IU_AppModule_Type_Name", true, "Type,Name")]
[BindTable("AppModule", Description = "应用插件。基于框架实现的应用功能插件", ConnName = "DG", DbType = DatabaseType.None)]
public partial class AppModule : IAppModule, IEntity<IAppModule>
{
    #region 属性
    private Int32 _Id;
    /// <summary>编号</summary>
    ...
    public void Copy(IAppModule model)
    {
        Id = model.Id;
        Name = model.Name;
