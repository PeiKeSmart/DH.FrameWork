...
[BindTable("AccessRule", Description = "访问规则。控制系统访问的安全访问规则，放行或拦截或限流", ConnName = "DG", DbType = DatabaseType.None)]
public partial class AccessRule : IAccessRule, IEntity<IAccessRule>
{
    #region 属性
    private Int32 _Id;
    /// <summary>编号</summary>
    ...
    public void Copy(IAccessRule model)
    {
        Id = model.Id;
        Name = model.Name;
        Enable = model.Enable;
