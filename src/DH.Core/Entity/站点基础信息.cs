        ...
        public override Object this[String name]
        {
            get
            {
                switch (name)
                {
                    ...
                    case "Hosts": return _Hosts;
                    case "SiteName": return _SiteName;
                    case "SiteLogo": return _SiteLogo;
                    case "Summary": return _Summary;
                    case "SiteTel": return _SiteTel;
                    case "SiteFax": return _SiteFax;
                    case "SiteEmail": return _SiteEmail;
                    case "QQ": return _QQ;
                    case "SiteMobile": return _SiteMobile;
                    case "WeiXin": return _WeiXin;
                    case "WeiBo": return _WeiBo;
                    case "SiteAddress": return _SiteAddress;
                    case "SiteCode": return _SiteCode;
                    case "SeoTitle": return _SeoTitle;
                    case "SeoKey": return _SeoKey;
                    case "SeoDescribe": return _SeoDescribe;
                    case "SiteCopyright": return _SiteCopyright;
                    case "Status": return _Status;
                    case "CloseInfo": return _CloseInfo;
                    case "Registration": return _Registration;
