    ...
    public static class RecyclableMemoryStream
    {
        ...
        private static RecyclableMemoryStreamManager RecyclableMemoryStreamManager
        {
            get
            {
                ...
                recyclableMemoryStream.Settings.MaximumSmallPoolFreeBytes = 64 * 1024 * 1024;
                recyclableMemoryStream.Settings.MaximumLargePoolFreeBytes = 64 * 1024 * 32;
                recyclableMemoryStream.Settings.AggressiveBufferReturn = true;
