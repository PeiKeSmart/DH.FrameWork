...
using DG.SafeOrbit.Memory.InjectionServices.Stampers.Serialization.SerializationServices.Advanced.Binary;
using DG.SafeOrbit.Memory.InjectionServices.Stampers.Serialization.SerializationServices.Advanced.Deserializing;
using DG.SafeOrbit.Memory.InjectionServices.Stampers.Serialization.SerializationServices.Advanced.Serializing;
using DG.SafeOrbit.Memory.InjectionServices.Stampers.Serialization.SerializationServices.Core;
using DG.SafeOrbit.Memory.InjectionServices.Stampers.Serialization.SerializationServices.Deserializing;
using DG.SafeOrbit.Memory.InjectionServices.Stampers.Serialization.SerializationServices.Serializing;

namespace DG.SafeOrbit.Memory.InjectionServices.Stampers.Serialization.SerializationServices
{
    /// <summary>
    ...
    internal sealed class SharpSerializer
    {
        ...
        public object Deserialize(Stream stream)
        {
            try
            {
                ...
                var factory = new Deserializing.ObjectFactory();
