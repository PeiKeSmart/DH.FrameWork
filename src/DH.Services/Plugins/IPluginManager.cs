...
namespace DH.Services.Plugins
{
    ...
    public partial interface IPluginManager<TPlugin> where TPlugin : class, IPlugin
    {
        ...
        /// </returns>
        Task<IList<TPlugin>> LoadAllPluginsAsync(User customer = null, int storeId = 0);
        ...
        /// </returns>
        Task<TPlugin> LoadPluginBySystemNameAsync(string systemName, User customer = null, int storeId = 0);
        ...
        /// </returns>
        Task<IList<TPlugin>> LoadActivePluginsAsync(List<string> systemNames, User customer = null, int storeId = 0);
