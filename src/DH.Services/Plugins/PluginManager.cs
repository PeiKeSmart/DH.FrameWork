...
namespace DH.Services.Plugins
{
    ...
    public partial class PluginManager<TPlugin> : IPluginManager<TPlugin> where TPlugin : class, IPlugin
    {
        ...
        /// </returns>
        protected virtual string GetKey(User customer, int storeId, string systemName = null)
        {
        ...
        /// </returns>
        public virtual async Task<IList<TPlugin>> LoadAllPluginsAsync(User customer = null, int storeId = 0)
        {
        ...
        /// The task result contains the plugin
        /// </returns>
        public virtual async Task<TPlugin> LoadPluginBySystemNameAsync(string systemName, User customer = null, int storeId = 0)
        {
        ...
        /// </returns>
        public virtual async Task<IList<TPlugin>> LoadActivePluginsAsync(List<string> systemNames, User customer = null, int storeId = 0)
        {
            if (systemNames == null)
