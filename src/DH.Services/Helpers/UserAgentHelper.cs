...
namespace DH.Services.Helpers
{
    ...
    public partial class UserAgentHelper : IUserAgentHelper
    {
        ...
        public virtual bool IsSearchEngine()
        {
            ...
            // 我们在try-catch块中放入了所需的逻辑
            //更多信息： https://www.nopcommerce.com/boards/topic/17711/unhandled-exception-request-is-not-available-in-this-context
            try
            {
        ...
        public virtual bool IsMobileDevice()
        {
            ...
            {
                // 这里不解析browscap库
                // 在99%的情况下，使用 http://detectmobilebrowsers.com/
