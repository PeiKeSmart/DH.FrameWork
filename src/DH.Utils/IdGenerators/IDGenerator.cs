...
/// <summary>
/// 受启发于 <see href="https://github.com/aspnet/KestrelHttpServer/blob/6fde01a825cffc09998d3f8a49464f7fbe40f9c4/src/Kestrel.Core/Internal/Infrastructure/CorrelationIdGenerator.cs"/>,
/// 此类生成有效的ID，该ID是<c>base32</c>编码的<see cref="long"/>
/// 使用字符 <c>1-9</c> 和 <c>A-V</c>.
/// </summary>
public sealed class IDGenerator
{
    ...
    /// <summary>
    /// 返回<see cref="IDGenerator"/>的单个实例.
    /// </summary>
    public static IDGenerator Instance { get; } = new IDGenerator();

    /// <summary>
    /// 返回ID. 示例: <c>0HLH7Q6V92BQE</c>
    /// </summary>
