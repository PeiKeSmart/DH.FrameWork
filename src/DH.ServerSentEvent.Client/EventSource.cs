...
public class EventSource : IEventSource, IDisposable {
    ...
    private void CancelCurrentRequest()
    {
        ...
        {
            XTrace.Log.Debug("Cancelling current request");
    ...
    {
        return new EventSourceService(configuration, _httpClient);
    }
    ...
    {
        XTrace.Log.Debug("Close({0}) - state was {1}", state, ReadyState);
    ...
    private void DispatchEvent()
    {
        ...
        XTrace.Log.Debug("Received event \"{0}\"", name);
