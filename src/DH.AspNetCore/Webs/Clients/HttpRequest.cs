...
public class HttpRequest : HttpRequestBase<IHttpRequest>, IHttpRequest {
    ...
    public async Task<TResult> ResultFromJsonAsync<TResult>() => JsonHelper.ToJsonEntity<TResult>(await ResultAsync());
}
...
public class HttpRequest<TResult> : HttpRequestBase<IHttpRequest<TResult>>, IHttpRequest<TResult>
    ...
    /// 获取Json结果
    /// </summary>
    public async Task<TResult> ResultFromJsonAsync() => JsonHelper.ToJsonEntity<TResult>(await ResultAsync());
}