...
public struct FileSize
{
    ...
    /// 获取文件大小，单位：K
    /// </summary>
    public double GetSizeByK() => Conv.ToDGDouble(Size / 1024.0, 2);

    /// <summary>
    /// 获取文件大小，单位：M
    /// </summary>
    public double GetSizeByM() => Conv.ToDGDouble(Size / 1024.0 / 1024.0, 2);

    /// <summary>
    /// 获取文件大小，单位：G
    /// </summary>
    public double GetSizeByG() => Conv.ToDGDouble(Size / 1024.0 / 1024.0 / 1024.0, 2);
